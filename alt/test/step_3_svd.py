...
CUDA_VISIBLE_DEVICES=2 nohup python step_3_svd.py \
  ...
  --step1_dir ./output/llama3_3b/step1_quant/2bit \
  --calib_s ./output/llama3_3b/calib_sqrtdiag.pt \
  --out_dir ./output/llama3_3b/step3_svd/1bit \
  --rank_ab 64 \
  --device cuda \
  --model_device_map auto > ./logs/qwen3_8b_64_4bit_svd.log 2>&1 &

CUDA_VISIBLE_DEVICES=2 python step_3_svd.py \
  --model_id Qwen/Qwen3-8B \
  --step1_dir ./output/qwen3_8b/step1_quant/3bit \
  --calib_s ./output/qwen3_8b/calib_sqrtdiag.pt \
  --out_dir ./output/qwen3_8b/step3_svd/3bit \
  --rank_ab 64 \
  --device cuda \
