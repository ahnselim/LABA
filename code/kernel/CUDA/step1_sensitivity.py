...
# Disable flash-attn auto-import by default because the binary often mismatches local PyTorch.
# Users can re-enable by exporting FLASH_ATTENTION_FORCE_DISABLE=0 before running the script.
...
def _disable_flash_attn_package():
    """Monkeypatch HF package detection so flash-attn is treated as unavailable."""
